...
urlpatterns = [
    ...
    path('filter_1/', views.FilterDataViewSet.as_view()),
    path('filter_2/', views.FloorFilterViewSet.as_view()),
    path('filter_3/', views.FullReservationDataForFilterView.as_view()),
    path('filter_4/', views.FullReservationDataForFilterWithEmptyDesksView.as_view()),
    path('filter_5/', views.DeskAvailabilityView.as_view()),
